...
import { getUserPosts, getNetworkPosts } from '@/lib/db';
...
export default function PostDisplay({ userId, showNetworkPosts = false }: PostDisplayProps) {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      try {
        setLoading(true);
        setError(null);
        const fetchedPosts = showNetworkPosts ?
