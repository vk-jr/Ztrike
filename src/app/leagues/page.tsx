          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-gray-600">
                {showMap ? "Basketball leagues from around the world" : "Major sports leagues from around the world"}
              </p>
            </CardHeader>
              ...
              {leagues.map((league) => (
                <div key={league.name} className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      variant={league.subscribed ? "default" : "outline"}
                      className="text-xs"
                    >
                      {league.subscribed ? "Subscribed" : "Subscribe"}
                    </Button>
