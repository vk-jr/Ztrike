        ...
        <div className="col-span-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <div className="relative">
                    <input
                      type="text"
                      placeholder="Share your training or match highlights..."
                      className="w-full px-4 py-2 rounded-full bg-gray-50 border border-gray-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                    />
                  </div>
                </div>
              </div>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              <h3 className="text-xl font-semibold mb-2">No posts in your feed yet</h3>
              <p className="text-gray-500 mb-4">
                Connect with more athletes or create your first post to get started!
              </p>
            </CardContent>
          </Card>
        </div>
